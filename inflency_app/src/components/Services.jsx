...
export default function Services() {
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-8">
              ...
              <Link to="/services" className="px-3 py-2 text-sm font-medium text-gray-900">Services</Link>
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-teal-400">Agency Services</span>
                </h1>
                <p className="mt-3 text-base text-blue-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Beyond our platform, we offer full-service agency solutions to help you maximize your influencer marketing strategy and execution.
                </p>
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <div className="rounded-md shadow">
                    <Link to="/contact" className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-gradient-to-r from-teal-500 to-teal-600 hover:from-teal-600 hover:to-teal-700 md:py-4 md:text-lg md:px-10">
                      Get a Quote
                    </Link>
                  </div>
      ...
      {/* Services Section */}
      <div id="services" className="py-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-16">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Strategy Development</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Our team of experts will develop a comprehensive influencer marketing strategy tailored to your brand goals, target audience, and budget.
                  </p>
                  <ul className="mt-4 space-y-2 text-sm text-gray-500 list-disc pl-5">
                    <li>Audience analysis and targeting</li>
                    <li>Platform selection and optimization</li>
                    <li>Campaign objective setting</li>
                    <li>Budget allocation and ROI forecasting</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Influencer Selection & Vetting</h3>
                  <p className="mt-2 text-base text-gray-500">
                    We identify and thoroughly vet the perfect influencers for your brand, ensuring authentic partnerships that resonate with your target audience.
                  </p>
                  <ul className="mt-4 space-y-2 text-sm text-gray-500 list-disc pl-5">
                    <li>Custom influencer discovery</li>
                    <li>Audience authenticity verification</li>
                    <li>Content quality assessment</li>
                    <li>Brand alignment evaluation</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  ...
                  <p className="mt-2 text-base text-gray-500">
                    From contract negotiation to content approval, we handle all aspects of campaign execution so you don't have to.
                  </p>
                  <ul className="mt-4 space-y-2 text-sm text-gray-500 list-disc pl-5">
                    <li>Influencer outreach and negotiation</li>
                    <li>Contract development and management</li>
                    <li>Content briefing and creative direction</li>
                    <li>Approval workflow and quality control</li>
                  </ul>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-16">
                  <h3 className="text-lg leading-6 font-medium text-gray-900">Analytics & Reporting</h3>
                  <p className="mt-2 text-base text-gray-500">
                    Comprehensive performance tracking and detailed reporting to measure campaign success and optimize future efforts.
                  </p>
                  <ul className="mt-4 space-y-2 text-sm text-gray-500 list-disc pl-5">
                    <li>Real-time performance monitoring</li>
                    <li>Engagement and conversion tracking</li>
                    <li>ROI calculation and analysis</li>
                    <li>Strategic recommendations for optimization</li>
                  </ul>
                </div>
              </div>
            </div>
          ...
          <div className="mt-16 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-8">
            <div className="relative p-8 bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col">
              <div className="flex-1">
                ...
                <p className="mt-6 text-gray-500">
                  Perfect for brands new to influencer marketing or with limited campaign needs.
                </p>
                ...
                <ul className="mt-6 space-y-6">
                  <li className="flex">
                    ...
                    <span className="ml-3 text-gray-500">Strategy development</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">5 influencer partnerships</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">Basic campaign management</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">Monthly performance reports</span>
                  </li>
                </ul>
              </div>

              <a href="#" className="bg-indigo-50 text-indigo-700 hover:bg-indigo-100 mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium">
                Get Started
              </a>
            </div>
            ...
            <div className="relative p-8 bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col">
              ...
              <div className="flex-1">
                ...
                <p className="mt-6 text-gray-500">
                  Comprehensive solution for brands serious about influencer marketing.
                </p>
                ...
                <ul className="mt-6 space-y-6">
                  <li className="flex">
                    ...
                    <span className="ml-3 text-gray-500">Advanced strategy development</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">15 influencer partnerships</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">Full campaign management</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">Bi-weekly performance reports</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">Content strategy assistance</span>
                  </li>
                </ul>
              </div>

              <a href="#" className="bg-indigo-600 text-white hover:bg-indigo-700 mt-8 block w-full py-3 px-6 border border-transparent rounded-md text-center font-medium">
                Get Started
              </a>
            </div>
            ...
            <div className="relative p-8 bg-white border border-gray-200 rounded-2xl shadow-sm flex flex-col">
              <div className="flex-1">
                ...
                <p className="mt-6 text-gray-500">
                  Tailored solutions for large brands with complex influencer marketing needs.
                </p>
                ...
                <ul className="mt-6 space-y-6">
                  <li className="flex">
                    ...
                    <span className="ml-3 text-gray-500">Custom strategy development</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">Unlimited influencer partnerships</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">Premium campaign management</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span className="ml-3 text-gray-500">Real-time performance dashboard</span>
                  </li>
                  <li className="flex">
                    <svg className="flex-shrink-0 w-6 h-6 text-green-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 13l4 4L19 7" />
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            <span className="block">Ready to elevate your influencer marketing?</span>
