        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            ...
            <div className="hidden sm:ml-6 sm:flex sm:items-center sm:space-x-8">
              ...
              <Link to="/for-influencers" className="px-3 py-2 text-sm font-medium text-gray-900">For Influencers</Link>
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-teal-400">influence and income</span>
                </h1>
                <p className="mt-3 text-base text-blue-100 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Join thousands of creators who are building sustainable careers through brand partnerships, exclusive content, and community engagement.
                </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
              Why Influencers Choose Inflency
            </p>
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Our platform is designed to help creators like you maximize your potential and build a sustainable career.
            </p>
          </div>
            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-3 md:gap-x-8 md:gap-y-10">
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Higher Earnings</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Our influencers earn 30% more on average compared to other platforms, with transparent payment terms and on-time deposits.
                </dd>
              </div>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Brand Matching</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Our AI-powered matching algorithm connects you with brands that align with your values, audience, and content style.
                </dd>
              </div>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Growth Resources</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                  Access exclusive workshops, networking events, and personalized coaching to accelerate your growth as a creator.
                </dd>
              </div>
            </dl>
          </div>
      ...
      <div className="py-16 bg-gradient-to-r from-blue-50 to-purple-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            ...
            <p className="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
              Everything you need to manage your brand partnerships and grow your audience.
            </p>
          </div>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-8">
              <div>
                ...
                <p className="mt-4 text-lg text-gray-500">
                  Create a stunning portfolio that highlights your best work, audience demographics, and past collaborations to attract premium brand partnerships.
                </p>
                <ul className="mt-8 space-y-5 lg:space-y-0 lg:grid lg:grid-cols-1 lg:gap-x-8 lg:gap-y-5">
                  ...
                  <li className="flex items-start lg:col-span-1">
                    ...
                    <p className="ml-3 text-sm text-gray-700">
                      Media integration from all platforms
                    </p>
                  </li>
                  <li className="flex items-start lg:col-span-1">
                    <div className="flex-shrink-0">
              ...
              <div className="mt-10 lg:mt-0">
                ...
                <p className="mt-4 text-lg text-gray-500">
                  Streamline your brand collaborations with our comprehensive campaign management tools, from proposal to payment.
                </p>
                <ul className="mt-8 space-y-5 lg:space-y-0 lg:grid lg:grid-cols-1 lg:gap-x-8 lg:gap-y-5">
                  <li className="flex items-start lg:col-span-1">
                    <div className="flex-shrink-0">
          ...
          <div className="mt-10">
            <div className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                <p className="text-gray-500 italic">"Since joining Inflency, my brand partnerships have increased by 200%. The platform's matching algorithm connected me with brands that perfectly align with my audience's interests."</p>
                <div className="mt-4 flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">Travel & Lifestyle Creator, 500K followers</p>
                  </div>
                </div>
              </div>
              
              <div className="bg-gray-50 rounded-lg p-6 shadow-sm">
                <p className="text-gray-500 italic">"The analytics dashboard has been a game-changer for my business. I can now show brands exactly how much value I bring to partnerships, which has helped me negotiate better deals."</p>
                <div className="mt-4 flex items-center">
                  <div className="flex-shrink-0">
                    <div className="h-10 w-10 rounded-full bg-gradient-to-r from-blue-600 to-purple-600"></div>
                  </div>
                  <div className="ml-3">
                    ...
                    <p className="text-sm text-gray-500">Tech Reviewer, 750K subscribers</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
          <h2 className="text-3xl font-extrabold tracking-tight text-white sm:text-4xl">
            <span className="block">Ready to grow your influence?</span>
            <span className="block text-blue-100">Join our community of creators today.</span>
          </h2>
